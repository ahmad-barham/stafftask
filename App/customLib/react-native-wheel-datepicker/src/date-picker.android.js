...
export default class DatePicker extends PureComponent {
    ...
    return [
      ...
      <View key='minute' style={styles.picker}>
        <Picker
          ...
          {...propsStyles}
          selectedValue={this.state.date.getHours()<=12? "am":"pm"}
          pickerData={aa}
  ...
  getValue() {
    const aa=moment(new Date()).format('A');
    const { year, month, date, hour, minute, aa} = this.newValue;
